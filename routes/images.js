...
const { addData, uploadToAws, handleFileUpload } = require("../controller/imagesController");
...
imagesRoutes.route("/s3").post(uploadImagetoS3.array("files",10), handleFileUpload)
